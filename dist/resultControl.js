...
var _ClientFetchPromise = /*#__PURE__*/new WeakSet();
var ResultBlock = exports["default"] = /*#__PURE__*/function () {
  function ResultBlock(json) {
    _classCallCheck(this, ResultBlock);
    _classPrivateMethodInitSpec(this, _ClientFetchPromise);
  ...
  _createClass(ResultBlock, [{
    ...
    value: function change() {
      ...
      document.getElementById('GenerateNext').addEventListener('click', function () {
        _this.GenerateNextHandler();
      });
    }
  }, {
    key: "convertColorDiv",
    value: function convertColorDiv(nxt) {
      var root = document.getElementById('output');
      for (; this.idx < nxt; ++this.idx) {
        var _this$colorArray$this = this.colorArray[this.idx].split('='),
          _this$colorArray$this2 = _slicedToArray(_this$colorArray$this, 2),
          key = _this$colorArray$this2[0],
          val = _this$colorArray$this2[1];
        if (!_classPrivateMethodGet(this, _checkRGBFormat, _checkRGBFormat2).call(this, key)) continue;
        var cur = document.createElement('div');
        cur.className = 'addedColorDiv';
        cur.innerHTML = "rgb".concat(key, " appears ").concat(val, " time(s)");
        root.appendChild(cur);
      }
    }
  }, {
    key: "handlePythonData",
    value: function () {
      var _handlePythonData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var dataPerTime, obj, time, res;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              time = 'data' in obj ? Number(obj['data']) > 4 * Math.pow(10, 11) ? Number.MAX_SAFE_INTEGER : Number(obj['data']) * dataPerTime : 10 * dataPerTime;
              _context.next = 5;
              return _classPrivateMethodGet(this, _ClientFetchPromise, _ClientFetchPromise2).call(this, time);
            case 5:
      ...
      function handlePythonData() {
        return _handlePythonData.apply(this, arguments);
      }
      return handlePythonData;
    }()
  }, {
    key: "initColorDiv",
    value: function initColorDiv() {
    ...
    key: "GenerateNextHandler",
    value: function GenerateNextHandler() {
      this.initColorDiv();
    }
  }, {
    key: "cleanUp",
...
function _ClientFetchPromise2(time) {
  var _this2 = this;
  //to Timeout fetch function
  var abortController = new AbortController();
  var abortSignal = abortController.signal;
  var timelimit = new Promise(function (_, rej) {
    setTimeout(function () {
      abortController.abort();
      rej('Time out!');
    }, time);
  });
  return Promise.race([fetch("http://localhost:".concat(this.port, "/running"), {
    method: 'POST',
    headers: {
