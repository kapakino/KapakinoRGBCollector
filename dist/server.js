    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          allowedOrigins = ['http://localhost', 'https://localhost', 'http://127.0.0.1:8080', 'https://127.0.0.1:8080'];
          ...
          arr = '';
          for (_i = 0, _Object$keys = Object.keys(dataToSent); _i < _Object$keys.length; _i++) {
            key = _Object$keys[_i];
            arr += "".concat(key, "=").concat(dataToSent[key], " ");
          }
          _context.prev = 10;
          imageData = undefined;
          cur_dir = __dirname;
          process.chdir("".concat(__dirname, "\\..\\py"));
          res.on('finish', function () {
            process.chdir(cur_dir);
            //delete the file
            fs.unlink("".concat(__dirname, "\\image\\output.jpg"), function (error) {
              if (error) console.error("".concat(error));
            });
            setTimeout(function () {
              console.log('executing');
              imageData.generateImg().then(function (res) {
                console.log('image be generated');
          ...
          _context.next = 17;
          return exec("python control.py ".concat(arr), {
            maxBuffer: maxBuffer
